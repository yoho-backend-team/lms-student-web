	...
	return (
		<div>
			...
			<div className=' flex lg:flex-row gap-5 md:flex-col-reverse'>
						...
						{activityLogs.map((data) => (
							...
							<section key={data.id} className='flex justify-between items-start py-6 gap-12 my-4 relative'>
								<div className='w-[240px]'>
									<p style={{ ...FONTS.heading_06 }}>{data.date}</p>
								</div>

								<div className='grid gap-6 w-3/4 relative pb-10'>

									<div className='btnshadow h-[100%] w-3 rounded-2xl  absolute left-0 text-transparent'> l</div>
									...
									<section className='flex items-center gap-8 relative'>
										<div className='relative'>
											<div className='h-9 w-9 rounded-full flex p-1 absolute left-[-10px] top-[-5px]' style={{
				...
				<div className='lg:w-[400px] md:w-fit'>
						...
						<div className='grid md:grid-cols-2 lg:grid-cols-1'>
							...
							<section className='flex gap-6 lg:justify-end mt-4'>
								...
								<div>
      							...
      							rgba(255, 255, 255, 0.7) 5px 5px 4px, 
      							rgba(189, 194, 199, 0.75) 2px 2px 3px inset`,
										}}>{toDate || "DD-MM-YYYY"}</button>
								</div>
							</section>

							{showFromCalendar && (
								<div className=' mt-6 p-1 rounded-lg ' style={{
									boxShadow:
										'rgba(189, 194, 199, 0.7) 2px 5px 4px,rgba(255, 255, 255, 0.4) 3px 2px 2px inset'
								}}>
									...
									<Calendar
										...
										onSelect={(selectedDate) => {
											...
											setShowFromCalendar(false); // hide after selection
										}}
										className="rounded-lg bg-gray-100 w-full **:gap-2"
