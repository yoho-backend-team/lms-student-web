						...
						<div className='p-5 h-[76vh] lg:grid lg:grid-cols-1 md:flex md:flex-wrap md:justify-evenly sm:grid sm:grid-cols-2  gap-6 custom-inset-shadow'>
							...
							<section className='custom-inset-shadow p-3 xs:p-4 grid gap-3 xs:gap-4'>
								<div className='flex gap-2 xs:gap-3'>
									<img src={Profile2} alt='Profile' className='w-6 h-6 xs:w-7 xs:h-7' />
									<p className='text-sm xs:text-base' style={{ ...FONTS.heading_07 }}>Amount Paid</p>
								</div>
								<p
							...
							<section className='custom-inset-shadow p-3 xs:p-4 grid gap-3 xs:gap-4'>
								<div className='flex gap-2 xs:gap-3'>
									<img src={Profile3} alt='Profile' className='w-6 h-6 xs:w-7 xs:h-7' />
									<p className='text-sm xs:text-base' style={{ ...FONTS.heading_07 }}>Pending Amount</p>
								</div>
								<p
									className='text-end text-base xs:text-lg'
							...
							<section className='custom-inset-shadow p-3 xs:p-4 grid gap-3 xs:gap-4'>
								<div className='flex gap-2 xs:gap-3'>
									<img src={Profile4} alt='Profile' className='w-6 h-6 xs:w-7 xs:h-7' />
									<p className='text-sm xs:text-base' style={{ ...FONTS.heading_07 }}>Status</p>
								</div>
								<p
									className='text-end text-base xs:text-lg'
							...
							<section className='custom-inset-shadow p-3 xs:p-4 grid gap-3 xs:gap-4'>
								<div className='flex gap-2 xs:gap-3'>
									<img src={Profile5} alt='Profile' className='w-6 h-6 xs:w-7 xs:h-7' />
									<p className='text-sm xs:text-base' style={{ ...FONTS.heading_07 }}>Payment Method</p>
								</div>
								<p
									className='text-end text-base xs:text-lg'
                      ...
                      shadow-[0px_2px_4px_0px_rgba(255,255,255,0.75)_inset,3px_3px_3px_0px_rgba(255,255,255,0.25)_inset,-8px_-8px_12px_0px_#7B00FF_inset,-4px_-8px_10px_0px_#B200FF_inset,4px_4px_8px_0px_rgba(189,194,199,0.75),8px_8px_12px_0px_rgba(189,194,199,0.25),-4px_-4px_12px_0px_rgba(255,255,255,0.75),-8px_-8px_12px_1px_rgba(255,255,255,0.25)] flex'
								...
								<div className='p-3 xs:p-4 sm:p-5 grid gap-2 xs:gap-3 custom-inset-shadow'>
									<div className='flex xs:flex-row justify-between gap-3 xs:gap-4'>
										...
										<section className='flex-1'>
											<h1 className='text-sm xs:text-base' style={{ ...FONTS.heading_07 }}>Category :</h1>
											<p className='text-xs xs:text-sm' style={{ ...FONTS.para_03 }}>{paymentDetails.length !== 0 ? paymentDetails?.fees[0]?.course_id?.course_name : "NA"}</p>
										</section>
										<section className='flex-1'>
											<h1 className='text-sm xs:text-base' style={{ ...FONTS.heading_07 }}>Enrolled Date :</h1>
											<p className='text-xs xs:text-sm' style={{ ...FONTS.para_03 }}>{new Date(paymentDetails.length !== 0 ? paymentDetails?.course?.createdAt : "NA").toLocaleDateString("en-GB", {
												day: "2-digit",
												month: "long",
												year: "numeric",
											})}</p>
									...
									<div className='space-y-2 xs:space-y-3'>
										<section className='flex justify-between'>
											<p className='text-sm xs:text-base' style={{ ...FONTS.para_02 }}>Tuition Amount</p>
											<p className='text-xs xs:text-sm' style={{ ...FONTS.para_03 }}>{paymentDetails.length !== 0 ? paymentDetails?.course_fees : 0} INR</p>
										</section>

										<section className='flex justify-between'>
											<p className='text-sm xs:text-base' style={{ ...FONTS.para_02 }}>Gst Cost</p>
											<p className='text-xs xs:text-sm' style={{ ...FONTS.para_03 }}>&#8377; {paymentDetails.length !== 0 ? paymentDetails?.fees[0]?.gst : 0} INR</p>
										</section>

										<section className='flex justify-between'>
											<p className='text-sm xs:text-base' style={{ ...FONTS.para_02 }}>Other Tax</p>
											<p className='text-xs xs:text-sm' style={{ ...FONTS.para_03 }}>&#8377; {paymentDetails.length !== 0 ? paymentDetails?.fees[0]?.other_taxes : 0} INR</p>
										</section>

										<section className='flex justify-between'>
											<p className='text-sm xs:text-base' style={{ ...FONTS.para_02 }}>Paid Amount</p>
											<p className='text-xs xs:text-sm' style={{ ...FONTS.para_03 }}>&#8377; {paymentDetails.length !== 0 ? paymentDetails?.payment_history[0]?.paid_amount : 0} INR</p>
										</section>
										...
										>
											...
											<p className='text-xs xs:text-sm'>{paymentDetails.length !== 0 ? paymentDetails?.pending_payment : 0} INR</p>
										</section>
									</div>
								</div>
							</div>
						...
						<div className='w-1/2 '>
                          ...
                          rgba(189, 194, 199, 0.75) 2px 2px 3px inset`,
								...
								<div className='flex flex-col xs:flex-row xs:justify-between xs:items-center mb-4 xs:mb-5 gap-2 xs:gap-0'>
									<h1 className='text-sm xs:text-base' style={{ ...FONTS.heading_05 }}>Pay Due</h1>
									<p className='text-xs xs:text-sm' style={{ ...FONTS.para_02 }}>{paymentDetails?.pending_payment != 0 ? "Pending Payments" : "No Pending Payments"}</p>
								</div>

								{paymentDetails?.payment_history?.map((paidFees: any) => {
									return (
										paidFees.balance !== 0 &&
										<section key={paidFees.index} className='custom-inset-shadow flex justify-between items-center p-2 xs:p-3 my-2 xs:my-3'>
											<h1
