...
const Classes = () => {
  ...
  return (
    <>
      <div style={{ backgroundColor: COLORS.bg_Colour }} className="mt-2 px-3 xs:px-4 sm:px-6 lg:px-8 xl:px-12 2xl:px-16">
        <h1 style={{ ...FONTS.heading_01 }} className="mb-4 text-lg xs:text-xl sm:text-2xl lg:text-3xl xl:text-4xl">
          Classes
        </h1>

        <Card style={{ backgroundColor: COLORS.bg_Colour }} className="p-3 xs:p-4 sm:p-6 lg:p-8">
          <h2 style={{ ...FONTS.heading_02 }} className="mb-4 text-base xs:text-lg sm:text-xl lg:text-2xl xl:text-3xl">
            Online Classes
          </h2>
