    ...
    <div className="mb-4">
      ...
      <div className="my-4 flex flex-row justify-start items-center gap-5">
        <div
          ...
          className="p-2 rounded-lg bg-[#ebeff3] shadow-[5px_5px_4px_rgba(255,255,255,0.7),2px_2px_3px_rgba(189,194,199,0.75)_inset]"
        >
          <img src={backImg} alt="back-img" />
        </div>
        <h1 style={{ ...FONTS.heading_01 }}>
      ...
      <div className="grid xl:grid-cols-2 md:grid-cols-1 justify-between gap-10">
        ...
        <Card
          ...
          className="px-4 py-1 h-[400px]"
        >
          <CardHeader>
            <CardTitle
              style={{ ...FONTS.heading_01 }}
              className="!text-[#7B00FF] mb-4"
            >
              {" "}
              Batch No: #{classIdData.data?.batch?.id}
            </CardTitle>
            <CardDescription>
              <h2
        ...
        >
          ...
          <Card
            style={{ ...FONTS.para_02 }}
            className="py-1 px-3 bg-[#ebeff3] shadow-[5px_5px_4px_rgba(255,255,255,0.7),2px_2px_3px_rgba(189,194,199,0.75)_inset] "
          >
