...
class Client {
    student = {
        login: (data: any, params: any) =>
            httpClient.post(
                HTTP_END_POINTS.auth.login,
                data,
                params,
                "student"
            ),
        logout: (data: any, params: any) => httpClient.post(HTTP_END_POINTS.auth.log_out, data, params, "student"),
        verifyOtp: (data: any, params: any) =>
            httpClient.post(
                HTTP_END_POINTS.auth.verify_otp,
                data,
                params,
                "student"
            ),
        ...
        profile: {
            ...
            update: (data: any) =>
                httpClient.update(
                    HTTP_END_POINTS.profile.update,
                    data,
                    "student"
                ),
        },
        ...
        payment: {
            get: (params: any) =>
                httpClient.get(
                    HTTP_END_POINTS.payments.getFees,
                    params,
                    "student"
                ),
        },
        ...
        attendance: {
            ...
            get_class_attendance: (data: { classId: any; }) => httpClient.get(`${HTTP_END_POINTS.attendance.class_attendance}/${data.classId}`, { params: data })
        },
        notification: {
            get: (params: any) => httpClient.get(HTTP_END_POINTS.notification.get, params, "student"),
            update: (data: { uuid: string; }) => httpClient.update(HTTP_END_POINTS.notification.update_status + data.uuid, data, "student"),
            delete: (data: { uuid: string; }) => httpClient.delete(HTTP_END_POINTS.notification.delete + data.uuid, data, "student")
        },
        ticket: {
            create: (data: any, params: any) =>
                httpClient.post(
                    HTTP_END_POINTS.ticket.create,
                    data,
                    params,
                    "student",
                ),
        ...
        reports: {
            get: (params: any) => httpClient.get(HTTP_END_POINTS.reports.get, params, 'student')
        },
        activity: {
        ...
        community: {
            get: (params: any) =>
                httpClient.get(
                    HTTP_END_POINTS.community.get,
                    params,
                    "student"
                ),
            get_messages: (params: { community: string; }) => httpClient.get(HTTP_END_POINTS.community.get_messages + params?.community, params, "student")
        },
    };
