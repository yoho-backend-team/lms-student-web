...
const Attendance: React.FC = () => {
    ...
    const attendanceBars = [
        {
            height: `h-[${Attendance?.[0]?.total?.percentage}%]`,
            top: "bottom-0",
            color:
        ...
        {
            height: `h-[${Attendance?.[0]?.present?.percentage}%]`,
            top: "bottom-0",
            color:
        ...
        {
            height: `h-[${Attendance?.[0]?.total?.percentage - Attendance?.[0]?.present?.percentage}%]`,
            top: "bottom-0",
            color:
                    ...
                    <div className="flex items-center gap-[30px] relative self-stretch w-full flex-[0_0_auto]">
                        <div className="inline-flex items-center gap-[30px] relative flex-[0_0_auto]">
                            {attendanceBars.map((bar, index) => (
                                ...
                                >
                                    <div
                                        className={`absolute  w-[26px] ${bar.height} ${bar.top} rounded-2xl ${bar.shadow} ${bar.color}`}
                                    />
                                </div>
                            ))}
                        </div>
