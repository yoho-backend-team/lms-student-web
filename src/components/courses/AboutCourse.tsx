  ...
  return (
    <div className="px-4 py-6 bg-[#F5F7FA] min-h-screen">
      ...
      <div className="flex justify-center gap-4 mb-12">
        <Button className="bg-[#7b00ff] hover:bg-[#7b00ff] text-white px-9 py-2 rounded-md shadow-[3px_3px_5px_rgba(255,255,255,0.7),inset_2px_2px_3px_rgba(189,194,199,0.75)]">
          About
        </Button>
