	...
	return (
		<div className='w-full mx-auto p-3 xs:p-4 sm:p-6'>
			...
			<div className='flex items-center gap-2 xs:gap-3 sm:gap-4 mb-4 xs:mb-5 sm:mb-6'>
				...
				<h1 className='text-black text-lg xs:text-xl sm:text-2xl lg:text-3xl font-semibold'>
					Task Projects
				</h1>
			</div>
				...
				<div className='flex flex-col'>
					...
					<Card className='bg-gradient-to-r from-[#7B00FF] to-[#B200FF] p-3 xs:p-4 sm:p-6 mx-2 xs:mx-3 sm:mx-4 sticky top-0 z-10 mb-2 xs:mb-3 sm:mb-4 hidden sm:block'>
						<div className='grid grid-cols-5 gap-2 xs:gap-3 sm:gap-4'>
							<div
								className='text-center !text-white text-xs xs:text-sm sm:text-base lg:text-lg'
							...
							tasks.map((task, index) => (
								...
								>
									...
									<div className='hidden sm:grid sm:grid-cols-5 gap-2 xs:gap-3 sm:gap-4 items-center'>
										<div
											className='text-center text-gray-600 text-xs xs:text-sm sm:text-base'
											style={{ ...FONTS.para_01 }}
										>
											{task.name}
										</div>
										<div
											className='text-center text-gray-600 capitalize text-xs xs:text-sm sm:text-base'
											style={{ ...FONTS.para_01 }}
										>
											{task.type}
										</div>
                          ...
                          ${
									...
									<div className='sm:hidden space-y-3'>
										...
										<div className='flex justify-between items-center'>
											...
											<span
												className='text-sm text-gray-600 text-right capitalize'
												style={{ ...FONTS.para_01 }}
											>
												{task.type}
											</span>
										...
										<div className='flex justify-between items-center'>
											...
											<span
												className='text-sm text-gray-600 text-right flex-1 ml-2'
												style={{ ...FONTS.para_01 }}
											>
												{task.task}
											</span>
