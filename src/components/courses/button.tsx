...
function Mainbutton() {
    ...
    <div className="flex flex-row gap-3  mb-12 flex align-items-center flex justify-center">
        <Button className="bg-[#EBEFF3] hover:bg-gradient-to-r from-[#7B00FF] to-[#B200FF] hover:text-white  font-semibold  boxshadow h-10 w-60 shadow-sm "   variant="outline" onClick={() => navigate("/about")} >
          About
        </Button>
