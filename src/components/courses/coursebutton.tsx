  ...
  return (
    <div className="flex justify-center gap-6 mb-12">
      <Button
        ...
        className={activeTabs === 'about' ? 'btnfocusshadow w-60 text-white' : inactiveBtnClass}
      >
        About
      </Button>
      ...
      <Button
        ...
        className={activeTabs === 'notes' ? 'btnfocusshadow w-60 text-white' : inactiveBtnClass}
      >
      ...
      <Button
        ...
        className={activeTabs === 'task' ? 'btnfocusshadow w-60 text-white' : inactiveBtnClass}
      >
        Task & Projects
      </Button>
      ...
      <Button
        ...
        className={activeTabs === 'track' ? 'btnfocusshadow w-60 text-white' : inactiveBtnClass}
      >
        Course Track
      </Button>
    </div>
