	...
	return (
		<div className='flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6'>
			...
			<div className='flex gap-3'>
				<button
					onClick={onExpandAll}
					className='px-6 py-2 rounded-lg font-medium transition-all duration-200 hover:opacity-90 active:opacity-80 btnshadow btnfocusshadow'
					style={{
            ...
            `,
				...
				<button
					...
					className='px-6 py-2 rounded-lg font-medium transition-all duration-200 hover:opacity-90 active:opacity-80 btnshadow text-white btnfocusshadow'
					style={{
						backgroundColor: COLORS.bg_Colour,
						color: COLORS.white,
						fontFamily: FONTS.heading_06.fontFamily,
