...
const PersonalInformation: React.FC<PersonalInformationProps> = ({
	...
	// Add useEffect to sync formData with data prop changes
	useEffect(() => {
		setFormData(data);
	}, [data]);
	...
	const fields = [
		{
			label: 'Mail Address',
			key: 'mailAddress' as keyof PersonalInfo,
			type: 'email',
			editable: false,
		},
		{
		...
		{
			label: 'Gender',
			key: 'gender' as keyof PersonalInfo,
			type: 'select',
		...
		},
		{
			...
			key: 'contactNumber' as keyof PersonalInfo,
			type: 'tel',
			editable: true,
		},
		{
			label: 'Alternate Contact Number',
			key: 'alternatecontactNumber' as keyof PersonalInfo,
			type: 'tel',
			editable: true,
		},
		{
			label: 'Date Of Birth',
			key: 'dateOfBirth' as keyof PersonalInfo,
			type: 'date',
			editable: true,
		},
		{
			label: 'Pin Code',
			key: 'pinCode' as keyof PersonalInfo,
			type: 'text',
			editable: true,
		},
		{
			label: 'Address',
			key: 'address' as keyof PersonalInfo,
			type: 'textarea',
			fullWidth: true,
			editable: true,
		},
