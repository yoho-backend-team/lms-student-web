...
const ProfileInformation: React.FC = () => {
  ...
  const [profileData, setProfileData] = useState({
    ...
    traineeId: profileDetails.length !=0? profileDetails.userDetail.studentId:"NA",
  ...
  const [personalInfo, setPersonalInfo] = useState({
    ...
    contactNumber:profileDetails.length !=0?  profileDetails.contact_info.phone_number:"NA",
    dateOfBirth: profileDetails.length !=0? profileDetails.dob:"NA",
    pinCode:profileDetails.length !=0?  profileDetails.contact_info.pincode:"NA",
    address: profileDetails.length !=0? profileDetails.contact_info.address2:"NA"
  });
