	...
	const navItems = [
		{
			...
			iconActive: (
				<RiDashboardHorizontalFill
					style={{ width: 24, height: 24, color: '#7B00FF' }}
				/>
			),
			iconInactive: (
				<RiDashboardHorizontalFill
					style={{ width: 24, height: 24, color: '#716F6F' }}
				/>
			),
		},
		{
			...
			name: 'Classes',
			iconActive: (
				<MdGroups style={{ width: 24, height: 24, color: '#7B00FF' }} />
			),
			iconInactive: (
				<MdGroups style={{ width: 24, height: 24, color: '#716F6F' }} />
			),
		},
		{
			path: 'courses',
			name: 'Courses',
			iconActive: (
				<GoClockFill style={{ width: 24, height: 24, color: '#7B00FF' }} />
			),
			iconInactive: (
				<GoClockFill style={{ width: 24, height: 24, color: '#716F6F' }} />
			),
		},
		{
			path: 'attendance',
			name: 'Attendance',
			iconActive: (
				<FaCalendarAlt style={{ width: 24, height: 24, color: '#7B00FF' }} />
			),
			iconInactive: (
				<FaCalendarAlt style={{ width: 24, height: 24, color: '#716F6F' }} />
			),
		},
		{
			path: 'payment',
			name: 'Payment',
			iconActive: (
				<MdPayment style={{ width: 24, height: 24, color: '#7B00FF' }} />
			),
			iconInactive: (
				<MdPayment style={{ width: 24, height: 24, color: '#716F6F' }} />
			),
		},
		{
			path: 'community',
			name: 'Community',
			iconActive: (
				<IoLogoWechat style={{ width: 24, height: 24, color: '#7B00FF' }} />
			),
			iconInactive: (
				<IoLogoWechat style={{ width: 24, height: 24, color: '#716F6F' }} />
			),
		},
		{
			path: 'placement',
			name: 'Placement',
			iconActive: (
				<IoBriefcase style={{ width: 24, height: 24, color: '#7B00FF' }} />
			),
			iconInactive: (
				<IoBriefcase style={{ width: 24, height: 24, color: '#716F6F' }} />
			),
		},
		{
			path: 'spoken-english',
			name: 'Spoken English',
			iconActive: (
				<SiEngadget style={{ width: 24, height: 24, color: '#7B00FF' }} />
			),
			iconInactive: (
				<SiEngadget style={{ width: 24, height: 24, color: '#716F6F' }} />
			),
		},
	];
				...
				<div className='flex gap-6'>
					...
					{showProfileSection && (
						...
						>
							<Card
								style={{ ...FONTS.para_01 }}
								className='bg-[#ebeff3] shadow-[3px_3px_5px_rgba(255,255,255,0.7),inset_2px_2px_3px_rgba(189,194,199,0.75)] h-[48px] w-[160px] cursor-pointer flex gap-2 justify-center btnhovershadow hover:!text-white'
							>
								<Link
					...
					<div className='relative bg-white w-96 rounded-2xl shadow-xl p-6 text-center'>
						...
						<div className='flex justify-center gap-4'>
							...
							<button
								...
								className='px-4 py-2 bg-gradient-to-l from-[#7B00FF] to-[#B200FF] text-white rounded-lg shadow hover:scale-105 transition'
							>
								Logout
							</button>
						</div>
