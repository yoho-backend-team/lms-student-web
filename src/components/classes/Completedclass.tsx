...
const Completedclass = () => {
  ...
  //route to class details page

  const handleClassDetailPage = () => {
    navigate("/class/:id")
  }

  return (
  <div style={{backgroundColor:COLORS.bg_Colour}}>

    <Card  style={{backgroundColor:COLORS.bg_Colour}} className='flex flex-row justify-between px-8 mb-4'>
        <h2 style={{...FONTS.heading_02}}>Class History</h2>
        <div>
      ...
      <table className="w-full">
        <tbody>
          <tr className="flex justify-around items-center" style={{...FONTS.heading_06,}}>
            ...
            <td>45 min</td>
            <td>
              <Button onClick={handleClassDetailPage} className="bg-gradient-to-r from-green-400 to-green-500 text-white  
