    ...
    <Routes>
      <Route path="/" element={<MainLayout />}>
        ...
        <Route path="courses" element={<Courses />}>
          ...
          <Route path=":course/note_materials" element={<NotesMaterials />} />
          <Route path=":course/task_projects" element={<Taskprojects />} />
          <Route path=":course/course_track" element={<CourseTrack />} />
        </Route>
